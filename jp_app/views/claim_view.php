                ...
                <div class="tabs divcenter nobottommargin clearfix" id="tab-login-register" style="max-width: 500px;">
                    ...
                    <?php echo $this->session->flashdata('msg');?>
                        <div class="col_full <?php echo (form_error('username'))?'has-error':'';?>">
                            ...
                            <input type="text" id="name" name="name" value="<?php echo set_value('username'); ?>" placeholder="User name used in D9" class="form-control" />
                            <?php echo form_error('username'); ?>
                        </div>

                        <div class="col_full <?php echo (form_error('full_name'))?'has-error':'';?>">
                            <label for="register-form-full-name">Full Name:</label>
                            <input type="text" id="full-name" name="full-name" value="<?php echo set_value('full_name'); ?>" placeholder="Your full name" class="form-control" />
                            <?php echo form_error('full_name'); ?>
                        </div>

                        <div class="col_full <?php echo (form_error('phone'))?'has-error':'';?>">
                            <label for="register-form-phone">Phone:</label>
                            <input type="text" id="register-form-phone" name="register-form-phone" value="<?php echo set_value('phone'); ?>" placeholder="Phone number" class="form-control" />
                            <?php echo form_error('phone'); ?>
                        </div>

                        <div class="col_full <?php echo (form_error('package_name'))?'has-error':'';?>">
                            <label for="register-form-username">Package Name:</label>
                            <input type="text" id="package" name="package" placeholder="Package you have bought in D9" value="<?php echo set_value('package_name'); ?>" class="form-control" />
