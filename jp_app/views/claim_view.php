                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="col_full <?php echo (form_error('package_name'))?'has-error':'';?>">
                                ...
                                <input type="text" id="package_name" name="package_name" value="<?php echo set_value('package_name'); ?>" placeholder="Package you have bought in D9" class="form-control" />
                                <?php echo form_error('package_name'); ?>
                            </div>

                            <div class="col_full">
                                <div class="bottommargin-sm <?php echo (form_error('country'))?'has-error':'';?>">
